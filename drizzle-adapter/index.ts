import * as schema from '@/lib/schema/User';

import { and, eq } from 'drizzle-orm';
import { pgTable as defaultPgTableFn } from 'drizzle-orm/pg-core';
...
export function pgDrizzleAdapter(client: PostgresJsDatabase<Record<string, never>>, tableFn = defaultPgTableFn): any {
  ...
  return {
    ...
    async getUserByAccount(account) {
      ...
      return (dbAccount as any).userAuth;
    },
